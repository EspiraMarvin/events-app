    ...
    <section className="mt-12 md:mt-0 md:pr-10">
      <div className="flex items-center gap-x-4">
        ...
        </h2>
        {
          ...
          className={`w-6 h-6 cursor-pointer ${showSearch && 'text-blue-600'}`}
         >
        ...
        {
          showSearch &&
          <svg onClick={() => setShowSearch(false)}  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-8 cursor-pointer">
      ...
      <div className='relative flex items-center'>
        ...
        { search.length > 0 &&
          <svg
            onClick={() => setSearch('')} 
            className="absolute w-6 h-8 mt-2 right-2 "
